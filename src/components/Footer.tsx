...
const Footer = () => {
  return (
    <footer className="mt-24 bg-foreground text-white/80">
      <div className="container mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div>
          <div className="text-[22px] font-bold tracking-[0.12em] uppercase mb-3 text-white/90">BYTECUBE</div>
        ...
        <div>
          ...
          <address className="not-italic space-y-1 text-white/70">
          ...
          <div className="flex gap-4 mt-4">
            <a href="https://www.linkedin.com/company/bytecubeai" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
              <Linkedin className="text-white/70" aria-hidden="true" />
            </a>
            <a href="https://twitter.com/bytecubeai" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
              <Twitter className="text-white/70" aria-hidden="true" />
            </a>
          </div>
        </div>
      </div>
      <div className="border-t border-white/10">
        <div className="container mx-auto px-6 py-6 text-sm text-center text-white/60">© 2025 BYTECUBE. All Rights Reserved.</div>
      </div>
    </footer>
  );
};
