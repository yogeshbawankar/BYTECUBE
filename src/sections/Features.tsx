const features = [
  { title: "Thoughtful by Design", text: "Human-centric, transparent systems that inspire trust.", icon: (
  ...
  { title: "Time Well Spent", text: "Focus on outcomes. Let automation handle the toil.", icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-foreground">
        <circle cx="12" cy="12" r="9" />
        <path d="M12 7v5l3 3" />
      </svg>
    ) },
  { title: "Lightbulb Moments", text: "Clarity at the right moment to move faster with confidence.", icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-foreground">
        <path d="M9 18h6"/>
        <path d="M10 22h4"/>
    ...
    <section className="py-20">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why ByteCube?</h2>
        </div>
